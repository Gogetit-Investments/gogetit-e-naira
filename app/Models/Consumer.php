...
class Consumer extends Model
{
    ...
    public $fillable = ['registration_number','tier_id', 'bvn', 'nin', 'first_name', 'last_name', 'other_names', 'added_by', 'phone_number', 'postal_code', 'address', 'city', 'lga', 'state', 'country', 'dob', 'country_of_birth', 'state_of_birth', 'referral_code', 'state_code', 'title_code'];
