					...
					<div class="dt-ext table-responsive">
						<table class="table" >
							...
							<tbody>
								...
								<tr>
									<td>{{$setting->app_name ?? null}}</td>
									<td>{{$setting->ceo_name ?? null}}</td>
									<td>{{$setting->referral_code ?? null}}</td>
									<td>&#8358;{{$setting->agent_commission ?? null}}</td>
									<td><a href="settings-edit/{{$setting->id ?? null}}"><button class="btn btn-square btn-primary " type="button">Edit</button></a></td>
