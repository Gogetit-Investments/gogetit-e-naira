...
<div class="container-fluid">
	<div class="edit-profile">
		<div class="row">
			...
			@endif
						<form method="POST" action="/update-settings/<?php echo $settings[0]->id ?>">
							@csrf
								...
								<div class="profile-title">
									<div class="media">
										...
										<div class="media-body">
											...
											<p>{{Auth::user()->role_info->role_name}}</p>
										</div>
									</div>
								</div>
							</div> --}}
							...
							<div class="mb-3">
								...
								<input class="form-control" type="text"  name="app_name" value="{{App\Models\Settings::select('app_name')->value('app_name')}}">
							</div>

							<div class="mb-3">
								<label class="form-label">CEO Name</label>
								<input class="form-control" type="text" name="ceo_name"  value="{{App\Models\Settings::select('ceo_name')->value('ceo_name')}}">
							</div>


							<div class="mb-3">
								<label class="form-label">Referral Code</label>
								<input class="form-control" type="text" name="referral_code"  value="{{App\Models\Settings::select('referral_code')->value('referral_code')}}">
							</div>


							<div class="mb-3">
								<label class="form-label">Agent Commission</label>
								<input class="form-control" type="text" name="agent_commission" value="{{App\Models\Settings::select('agent_commission')->value('agent_commission')}}">
							</div>
							{{-- <div class="mb-3">
