        ...
        <div class="card">
          ...
          <div class="card-body file-manager">
            ...
            <ul class="files">
              ...
              <a href="{{ asset('assets/Consumer_Bulk_Onboarding_Template.xlsx')}}"><li class="file-box">
              ...
              <a href="{{ asset('assets/Merchant_Bulk_Onboarding_Template.xlsx')}}"><li class="file-box">
                <div class="file-top">  <i class="fa fa-file-excel-o txt-success"></i></i></div>
                <div class="file-bottom">
